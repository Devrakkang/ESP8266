...
const char* ssid = "ProjectBig"; // ชื่อ ssid
const char* password = "warapolkang"; // รหัสผ่าน wifi
#define APPID "netpieControl"
#define KEY "IiRvJbQFmhMi6aE"
#define SECRET "e8U7r64noMapoT71raetSwwco"
#define ALIAS "esp8266" // แทนที่ด้วยหมายเลขของท่าน เช่น “A01”
#define NEIGHBOR "Datasource1" // ชื่ออุปกรณ์ของเพื่อน เช่น “A02”
// — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — —
